                                                ...
                                                <form action="{{route('leave_type.update',['id'=>$leave_type->id])}}" method="post">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input  type="text" name="code" value="{{old('count',$leave_type->code)}}" placeholder="Enter Code Here" class="form-control">
                                                        </div>
                                                        <div class="form-group">
            ...
            <div class="modal-content">
                <form action="{{route('leave_type.create')}}" method="post">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="control-label">Code</label>
                            <input type="text" name="code" placeholder="Enter Leave Code here" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Status</label>
                            <select  name="status"  class="form-control">
