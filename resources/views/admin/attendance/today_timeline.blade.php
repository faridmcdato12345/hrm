                    ...
                    @if(count($employees) > 0) @foreach($employees as $employee)
                        ...
                        <tr>
                            ...
                            <td>
								...
								@endphp
									@if($x)
									{{Carbon\Carbon::parse($x->clock_in)->format('h:i a')}}
									@else
										<p type="button" class="btn btn-danger">absent</p>
									@endif
							</td>
							<td>
								@php
								...
								@endphp
									@if($x)
										@if(!empty($x->clock_out))
											{{Carbon\Carbon::parse($x->clock_out)->format('h:i a')}}
										@else
											<p></p>
										@endif
									@else
