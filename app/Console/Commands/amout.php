...
class amout extends Command
{
     ...
     * @var string
     */
    protected $description = 'HR Executes AM Out';
    ...
    public function handle()
    {
        ...
        foreach($employees as $employee){
            ...
            if($checkAM === 0){
                ...
                $clock_inAM = NULL;
                $clock_outAM = Carbon::parse($att_date.' '.$am[1].' +08:00')->format('Y-m-d H:i:sP');
                ...
                $this->line('AM Out Row Doesnt Exist, Create Executed. '.'Dated: '.Carbon::now()->format('Y-m-d H:i').' ID ='.$emp_id.' '.$uuidAM);
            }else{
                // For AM
                $clock_outAM = Carbon::parse($att_date.' '.$am[1].' +08:00')->format('Y-m-d H:i:sP');
                DB::connection('pgsql_external')
                ...
                $this->line('AM Out Row Already Exist, Update Executed. '.'Dated: '.Carbon::now()->format('Y-m-d H:i').' ID ='.$emp_id.' '.$checkAM);
            }
        }
